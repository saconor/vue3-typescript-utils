<template>
  <div class="pt-2 pb-2 d-flex flex-column" :class="[displayMode]" v-if="ownSelection">
...
export default class TabSwitch extends Vue {
  @Prop({ required: true, type: Array as () => TabSelector[] }) tabSelectors!: TabSelector[];
  @Prop({ required: true, type: Object as () => TabSelector }) selectedTabSelector!: TabSelector;
