  ...
  <div class="home">
    ...
    <div class="props">
      ...
      <ul>
        ...
        <li>paginated:boolean ( defines if pagination is used or not)</li>
        <li>fields:Tablefields&lt;T&gt;[] (The Colum definition)</li>
        <li>tableData:T[] (The data to Display)</li>
    ...
    <h3 class="pt-2">TableField</h3>
    <div class="">
      You can specify the table with specific table fields with the following
      options
    </div>
    <ul class="pb-5">
      <li>title: string;</li>
      <li>id: string;</li>
      <li>customCss?: string[];</li>
      <li>clickable?: boolean;</li>
      <li>clickfkt?: (value: T) => void;</li>
      <li>sortable?: boolean;</li>
      <li>sortfkt?: (value1: T, value2: T) => number;</li>
      <li>filterable?: boolean;</li>
      <li>filterfkt?: () => void;</li>
      <li>filtertype?: string;</li>
      <li>formatter?: (value: T) => string;</li>
      <li>htmlFormatter?: (value: T) => string;</li>
    </ul>
  </div>
</template>
